...
<div class="bg-primary">
    <div class="bg-pattern bg-black-op-25" style="background-image: url('{{ asset('assets/img/various/bg-pattern.png') }}')">
        <div class="content content-top text-center">
            <h1 class="font-w700 text-white mb-10">שיעורי בית</h1>
            <h2 class="h4 font-w400 text-white-op">כאן ניתן לראות את רשימת שיעורי הבית להגשה.</h2>
        </div>
    </div>
</div>
    ...
    <div class="col-xl-12 col-xs-12">
        <div class="block block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title">טבלת שיעורי הבית</h3>
            </div>
            <div class="block-content">
                <table id="homeworkTable" class="table table-bordered table-hover table-vcenter dt-responsive nowrap">
                    <thead class="thead-light">
                        <tr>
                            <th class="text-center">מקצוע</th>
                            <th class="text-center">שם מורה</th>
                            <th class="text-center">תאריך הגשה</th>
...
@include('assets.js.student.homework')
@stop
