...
<div class="bg-primary">
    <div class="bg-pattern bg-black-op-25" style="background-image: url('{{ asset('assets/img/various/bg-pattern.png') }}')">
        <div class="content content-top text-center">
            <h1 class="font-w700 text-white mb-10">דף מבחנים</h1>
            <h2 class="h4 font-w400 text-white-op">כאן ניתן לראות את דף המבחנים של החודש.</h2>
        </div>
    </div>
</div>
    ...
    <div class="col-xl-12 col-xs-12">
        <div class="block block-bordered">
            <div class="block-header block-header-default">
                <h3 class="block-title">דף המבחנים</h3>
            </div>
...
@include('assets.js.student.exams_schedule')
@stop
