...
<div class="bg-primary">
    <div class="bg-pattern bg-black-op-25" style="background-image: url('{{ asset('assets/img/various/bg-pattern.png') }}')">
        <div class="content content-top text-center">
            <h1 class="font-w700 text-white mb-10">דף קשר כיתתי</h1>
            <h2 class="h4 font-w400 text-white-op">כאן ניתן לראות את רשימת התלמידים מהכיתה שלי בבית הספר.</h2>
        </div>
    </div>
</div>
<div class="content">
        ...
        <div class="col-md-12">
            ...
            <div class="block">
                <div class="block-header block-header-default">
                    <h3 class="block-title">טבלת רשימת תלמידים איתי בכיתה</h3>
...
@include('assets.js.global.studentscontact')
@stop