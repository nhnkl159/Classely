...
$(document).ready(function()
{
    ...
    var div = $("#examsTable_wrapper").find(".row:first div.col-sm-12.col-md-6:first");
    $(div).addClass('row');
    $(div).addClass('mr-5');
    $(div).addClass('mb-5');
...
$(document).on('change','#dateFrom, #dateTo',function()
{
    ...
    $('#examsTable').dataTable().api().column(2).search('', true, false).draw();
});
